                ...
                public void onResponse(String response) {
                    try {
                        ...
                        if (!error) {
                            ...
                            JSONArray basketitem = new JSONArray();//array = menu.getJSONArray("menu");
    ...
    */
    ...
    private class warehousedetails_ListAdapter extends ArrayAdapter<model_pro_stk_warehouse> {
        ...
        warehousedetails_ListAdapter() {
            super(SelectBasket.this, R.layout.select_warehouse_name, listArray);
        }
...
*/
            ...
            View.OnClickListener warehouselistener = new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    Intent newwarehousesum = new Intent(SelectBasket.this, WareHouseSummary.class);
